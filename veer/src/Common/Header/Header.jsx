...
const Header = () => {
  const { Navigate, location, searchTerm, setSearchTerm,setLogopen,opendrop,closedrop} = useContext(MyContext)
  ...
  return (
    <>
      <header>
        ...
        <button className='btn1s'  onClick={opendrop}>Apply For Passport</button>
       <Droplist/>
        </div>
        }
